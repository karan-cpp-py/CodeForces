...
void solution(){
    ...
    while(t--){
        ...
        if((x1==1 && y1==1) || (x1==n && y1==1) || (x1==1 && y1==m) || (x1==n && y1==m) || (x2==1 && y2==1) || (x2==n && y2==1) || (x2==1 && y2==m) || (x2==n && y2==m)) cout<<2<<endl;
        else if(x1-1==0 || x1-n==0 || y1-1==0 || y1-m==0 || x2-1==0 || x2-n==0 || y2-1==0 || y2-m==0) cout<<3<<endl;
        else cout<<4<<endl;
    }
}
