...
ll fun(ll num1,ll num2, ll n){
    num1--; num2--;
    num1=min(num1,n-num1-1);
    num2=min(num2,n-num2-1);
...
void solution(){
    int t; cin>>t;
    while(t--){
        ll n,numx1,numy1,numx2,numy2; cin>>n>>numx1>>numy1>>numx2>>numy2;
        cout<<abs(fun(numx1,numy1,n)-fun(numx2,numy2,n))<<endl;
    }
}
